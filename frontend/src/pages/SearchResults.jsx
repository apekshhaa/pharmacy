...
return (
<div className="p-10">
<h2 className="text-xl mb-6">Results for: {query}</h2>
<div className="space-y-6">
{[1, 2, 3].map((i) => (
<div key={i} className="flex gap-4 p-4 bg-white rounded-xl shadow">
<div className="w-12 h-12 bg-blue-100 rounded" />
<div>
<h3 className="font-semibold">Medicine / Info {i}</h3>
<p className="text-sm">Usage and details shown here.</p>
</div>
</div>
))}
</div>
